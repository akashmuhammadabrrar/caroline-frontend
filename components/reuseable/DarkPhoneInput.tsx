      ...
      <Controller
        ...
        render={({ field: { onChange, value } }) => {
          ...
          if (matchedCode) {
            ...
            const exactCode = countryCodes.find((c) =>
              stringValue.startsWith(c.code),
            )?.code;
          ...
          return (
            <div
              className={
                className ||
                `flex items-center w-full bg-[#050B14]/60 border rounded-xl overflow-hidden transition-all duration-300
              ${
                error
            ...
            >
              ...
              <div
                className={`relative border-r border-white/10 shrink-0 ${dropdownClassName || ""}`}
              >
                {/* Visual Display */}
                    ...
                    return (
                      <div className="flex items-center gap-2">
                        <img
                          ...
                          alt="Flag"
                          className="w-8 h-auto rounded-[2px] shadow-sm brightness-90 group-hover:brightness-100 transition-all border border-white/10"
                        />
